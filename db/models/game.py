...
class Game:
    ...
    game_type_id: int = field(metadata={"sa": Column(Integer, ForeignKey('teams.id'), nullable=False)})
    ...
    home_team_points: int = field(metadata={"sa": Column(Integer)})
    away_team_points: int = field(metadata={"sa": Column(Integer)})
